...
QT_MOC_LITERAL(4, 50, 13), // "errorOccurred"
QT_MOC_LITERAL(5, 64, 5), // "error"
QT_MOC_LITERAL(6, 70, 19) // "databaseInitialized"

    },
    "DatabaseManager\0connectionStateChanged\0"
    "\0connected\0errorOccurred\0error\0"
    "databaseInitialized"
};
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->databaseInitialized(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DatabaseManager::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::connectionStateChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::databaseInitialized)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void DatabaseManager::connectionStateChanged(bool _t1)
{
