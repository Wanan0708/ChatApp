...
QT_MOC_LITERAL(1, 13, 5), // "Roles"
QT_MOC_LITERAL(2, 19, 11), // "ContentRole"
QT_MOC_LITERAL(3, 31, 12), // "SenderIdRole"
QT_MOC_LITERAL(4, 44, 13), // "TimestampRole"
QT_MOC_LITERAL(5, 58, 10) // "IsSelfRole"

    },
    "MessageModel\0Roles\0ContentRole\0"
    "SenderIdRole\0TimestampRole\0IsSelfRole"
};
...
static const uint qt_meta_data_MessageModel[] = {
 ...
 // enum data: key, value
       2, uint(MessageModel::ContentRole),
       3, uint(MessageModel::SenderIdRole),
       4, uint(MessageModel::TimestampRole),
       5, uint(MessageModel::IsSelfRole),
